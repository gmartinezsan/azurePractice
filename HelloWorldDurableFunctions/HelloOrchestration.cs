...
namespace my.durablefunction
{
    public static class HelloOrchestration
    {
        ...
        public static async Task<HttpResponseMessage> HttpStart(
            ...
            ILogger log)
        {
            var persons = await req.Content.ReadAsAsync<PersonsList>();

            // Function input comes from the request content.
            string instanceId = await starter.StartNewAsync("HelloOrchestration", persons);
